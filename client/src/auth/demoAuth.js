...
//   login page.
let attempted = false;
export function tryDemoAutoLogin() {
    ...
    return axios
        ...
        console.info("%c[A1 Fitness] DEMO MODE ACTIVE — signing in as the demo gym admin. Disable by setting DEMO_MODE=false on the server.", "color:#f59e0b;font-weight:bold");

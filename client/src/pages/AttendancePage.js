...
const AttendancePage = () => {
    ...
    const fetchAttendance = () => {
        ...
        if (effectiveBranchCode)
            params.branchCode = effectiveBranchCode;
        if (debouncedSearch)
    ...
    const handleManualAction = async (memberId, action) => {
        ...
        try {
            ...
            if (isSuperAdmin && selectedBranchCode)
                payload.branchCode = selectedBranchCode;
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "page-header", style: { marginBottom: '2rem', position: 'relative', overflow: 'hidden', borderRadius: '16px' }, children: [_jsx("div", { style: {
                        ...
                        } }), _jsx("div", { style: { position: 'relative', zIndex: 2 }, children: _jsxs("div", { className: "flex-responsive", style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1.5rem' }, children: [_jsxs("div", { children: [_jsx("h1", { style: { color: 'white', textShadow: '0 2px 8px rgba(0,0,0,0.3)' }, children: "Attendance Tracking" }), _jsx("p", { className: "text-muted", style: { color: 'rgba(255,255,255,0.9)' }, children: showBranchSelector
